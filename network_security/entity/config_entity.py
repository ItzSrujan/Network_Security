...
class TrainingPipelineConfig:
    def __init__(self, time_stamp = datetime.now()):
        ...
        self.final_model = os.path.join("final_models")
...
class DataTransformConfig:
    def __init__(self, training_pipeline_config : TrainingPipelineConfig):
        ...
        self.transformed_obj_file_path : str = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJ_DIR,
